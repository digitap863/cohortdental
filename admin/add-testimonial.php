...
<html lang="en">
    ...
    <body>
          ...
          <div class="heading">
            <h3 style="font-size:20px;margin-top:0;padding:18px">Add New Testimonial</h3>
          </div>  
          ...
          <div class="col-md-9 form-container">
            ...
            <div class="content">
            <form method="post" id="file-upload-form" action="upload/upload-testimonial.php" enctype="multipart/form-data">
      
            <label style="margin-bottom:10px">Upload Client Photo</label>
            ...
            <label style="font-size:13px">Maximum upload size: 500KB</label>

            <div class="input-container">
            <!-- <label>Name of the Client</label> -->
            <input type="text" name="client_name" class="input" required>
            <label class="label">Name of the Client</label>
            </div>
      
            <div class="input-container">
            <textarea name="test_desc" class="input" style="width:100%;height:70px" required></textarea>
