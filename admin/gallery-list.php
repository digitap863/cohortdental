		...
		<div class="table-widget">
			<span class="caption-container">
				<span class="table-title">
					...
					Gallery Images (Scroll Through The Table)
          <a href="add-gallery.php"><button class="btn back-btn">Back To Add Image</button></a>
				</span>
			...
			<h1 style="color:#272727">Gallery Images</h1>
      ...
      while($row=mysqli_fetch_assoc($result)) {
          ...
          $category=$row['category'];
					...
					<td class="stock sticky-left">
						...
						<a href="upload/gallery_uploads/'.$image_url.'" onclick="preventImageNavigation(event);">
            <img src="upload/gallery_uploads/'.$image_url.'" alt="Shell plc">
            </a>
						</div>
					</td>
					...
					<div class="stock-info">
							<span class="stock-info__ticker">'.$category.'</span>
					</div>
					</td>
